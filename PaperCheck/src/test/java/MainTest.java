...
public class MainTest {
        ...
        public void origAndAllTest(){
            ...
            str[0] = TxtInOutils.readTxt("D:/test/orig.txt");
            str[1] =TxtInOutils.readTxt("D:/test/orig_0.8_add.txt");
            str[2] = TxtInOutils.readTxt("D:/test/orig_0.8_del.txt");
            str[3] = TxtInOutils.readTxt("D:/test/orig_0.8_dis_1.txt");
            str[4] = TxtInOutils.readTxt("D:/test/orig_0.8_dis_10.txt");
            str[5] = TxtInOutils.readTxt("D:/test/orig_0.8_dis_15.txt");
            ...
            for(int i = 0; i <= 5; i++){
                ...
                TxtInOutils.writeTxt(ans, ansFileName);
            }
        }
        ...
        public void origAndOrigTest(){
            ...
            String str1 = TxtInOutils.readTxt("D:/test/orig.txt");
        ...
        public void origAndDelTest(){
            String str0 = TxtInOutils.readTxt("D:/test/orig.txt");
            String str1 = TxtInOutils.readTxt("D:/test/orig_0.8_del.txt");
        ...
        public void origAndDis1Test(){
            String str0 = TxtInOutils.readTxt("D:/test/orig.txt");
            String str1 = TxtInOutils.readTxt("D:/test/orig_0.8_dis_1.txt");
        ...
        public void origAndDis10Test(){
            String str0 = TxtInOutils.readTxt("D:/test/orig.txt");
            String str1 = TxtInOutils.readTxt("D:/test/orig_0.8_dis_10.txt");
        ...
        public void origAndDis15Test(){
            String str0 = TxtInOutils.readTxt("D:/test/orig.txt");
            String str1 = TxtInOutils.readTxt("D:/test/orig_0.8_dis_15.txt");
